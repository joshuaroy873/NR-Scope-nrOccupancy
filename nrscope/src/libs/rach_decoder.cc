...
int copy_c_to_cpp_complex_arr_and_zero_padding_msg4(cf_t* src, std::complex<float>* dst, uint32_t sz1, uint32_t sz2) {
...
int copy_cpp_to_c_complex_arr_msg4(std::complex<float>* src, cf_t* dst, uint32_t sz) {
