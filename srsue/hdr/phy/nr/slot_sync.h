...
public:
  ...
  bool init_no_stack(const args_t& args, srsran::radio_interface_phy* radio_);
  ...
  int  recv_callback_no_tti(srsran::rf_buffer_t& rf_buffer, srsran_timestamp_t* timestamp);
